# WebSocket 906, 1132 и 1333: подготовка и подключение
...
значением должен быть один JSON-объект. Сборки 1132 и 1333 также принимают
...
В сборках 906, 1132 и 1333 тестовый клиент может отправлять строку `$hbt`
