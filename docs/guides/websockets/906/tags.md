...
API тегов сохранён в сборках 1132, 1333 и 1515. В 1515 улучшена работа со
значениями тегов, в том числе у удалённых сокетов. Примеры ниже проверены на
стенде 906.
